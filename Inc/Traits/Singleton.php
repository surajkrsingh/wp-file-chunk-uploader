...
trait Singleton {
	...
	final public static function get_instance() {
		...
		if ( ! isset( $instance[ $called_class ] ) ) {
			...
			/**
			 * Dependent items can use the bit_background_process_features_singleton_init_{$called_class} hook to execute code
			 */
			do_action( sprintf( 'wp_fcu_features_singleton_init_%s', $called_class ) );
